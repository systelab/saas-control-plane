package com.systelab.modulab.controller;

import com.systelab.modulab.model.user.User;
import com.systelab.modulab.service.UserService;
...
@RequestMapping(value = "/modulab/v1", produces = MediaType.APPLICATION_JSON_VALUE)
